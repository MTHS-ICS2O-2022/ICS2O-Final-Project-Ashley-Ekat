...
function crystalButton() {
  ...
  if (
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/garnet.jpg" alt="Garnet" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/amythest.jpg" alt="Amethyst" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/aquamarine.png" alt="Aquariume" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/pearls.jpg" alt="Pearl" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/peridot.png" alt="Peridot" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/saphire.jpg" alt="Saphire" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/opal.jpg" alt="Opal" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/topaz.png" alt="Topaze" />'
    ...
    document.getElementById("image").innerHTML =
      '<img src="./images/turquoise.jpg" alt="Turquoise" />'
  } else {
    document.getElementById("crystalName").innerHTML =
